...
model_path = "tts_vits/vits_models/Haruhi_54000.pth"
config_path = "tts_vits/configs/config.json"
...
def infer_to(spk, tran, voice):
    ...
    res_path = f'tts_vits/vits_results/{tran}key_{spk}_{str(uuid.uuid4())}.{wav_format}'
