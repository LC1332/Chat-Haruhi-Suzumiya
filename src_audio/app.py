...
import random
import time
from tts_vits import vits_haruhi
...
openai.api_key = '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'  # 在这里输入你的OpenAI API Token
...
if __name__ == '__main__':
    ...
    #vits_haruhi.vits_haruhi("真実はいつもひとつ", 8)
    run = Run(**params)
    run.create_gradio()
